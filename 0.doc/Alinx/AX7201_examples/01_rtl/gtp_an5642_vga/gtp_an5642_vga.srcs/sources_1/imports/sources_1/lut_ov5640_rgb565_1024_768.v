...
begin
	case(lut_index)			  
		...
		10'd127: lut_data <= {8'h78 , 24'h583dce};// lenc BR offset // AWB   自动白平�?
		...
		10'd186: lut_data <= {8'h78 , 24'h538b98}; // sign[8:1] // UV adjust   UV色彩饱和度调�?
		...
		10'd193: lut_data <= {8'h78 , 24'h501d40};// enable manual offset of contrast// CIP  锐化和降�? 
		...
		10'd255: lut_data <= {8'h78 , 24'h382100}; // mirror
		...
		10'd261: lut_data <= {8'h78 , 24'h3803fa}; // VS
