...
begin
	case(lut_index)			  
		...
		10'd 36: lut_data <= {8'h78 , 24'h362201}; // 50/60Hz detection     50/60Hz 鐏厜鏉＄汗杩囨�?
		...
		10'd 59: lut_data <= {8'h78 , 24'h5000a7}; // Lenc on, raw gamma on, BPC on, WPC on, CIP on // AEC target    鑷姩鏇濆厜鎺у埗
		...
		10'd 65: lut_data <= {8'h78 , 24'h3a1f14};// fast zone low// Lens correction for ?   �?滃ご琛ュ�?
		...
		10'd127: lut_data <= {8'h78 , 24'h583dce};// lenc BR offset // AWB   鑷姩鐧藉钩�?
		...
		10'd158: lut_data <= {8'h78 , 24'h519e38};// AWB control // Gamma    浼界帥鏇茬嚎
		...
		10'd175: lut_data <= {8'h78 , 24'h54901d};// color matrix   鑹插僵鐭╅樀
		...
		10'd186: lut_data <= {8'h78 , 24'h538b98}; // sign[8:1] // UV adjust   UV鑹插僵楗卞拰搴﹁皟鏁
		...
		10'd193: lut_data <= {8'h78 , 24'h501d40};// enable manual offset of contrast// CIP  閿愬寲鍜岄檷�?
