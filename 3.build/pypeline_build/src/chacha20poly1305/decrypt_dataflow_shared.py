...
def decrypt_dataflow_shared():
    ...
    strip_axis_out_ready_s: uint1_t = (
        prep_auth_data_decrypt.axis_in_ready & chacha20_decrypt_shared.axis_in_ready
    )
    ...
    if strip_axis_out_s.valid:
        ...
        if strip_axis_out_ready_s | ~chacha20_decrypt_shared.axis_in_ready:
            chacha_axis_in_s.valid = 1

    # Connect data streams
    prep_auth_data_decrypt.axis_in = prep_axis_in_s
    chacha20_decrypt_shared.axis_in = chacha_axis_in_s
