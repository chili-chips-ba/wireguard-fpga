...
"""Nice struct/array type globally visible wires used as the encrypt design's
...
(chacha20poly1305_encrypt_hw_io.py).
...
axis_in: Wire[axis128_intrf.fwd_t]  # input
...
axis_out: Wire[axis128_intrf.fwd_t]  # output
