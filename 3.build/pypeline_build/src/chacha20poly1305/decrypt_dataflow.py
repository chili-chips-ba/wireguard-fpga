...
def decrypt_dataflow():
    r = decrypt_dataflow_core(
        ...
        chacha20_decrypt.axis_in_ready,
        chacha20_decrypt.poly_key,
        chacha20_decrypt.axis_out,
    ...
    chacha20_decrypt.key = r.chacha_key
    chacha20_decrypt.nonce = r.chacha_nonce
    chacha20_decrypt.axis_in = r.chacha_axis_in
    chacha20_decrypt.poly_key_ready = r.chacha_poly_key_ready
    chacha20_decrypt.axis_out_ready = r.chacha_axis_out_ready
