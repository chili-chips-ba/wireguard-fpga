...
"""prep_auth_data instance for the encrypt design: globally visible wires +
the FSM MAIN.

Pypeline port of ../pipelinec_build/src/prep_auth_data/prep_auth_data.c with
PREP_AUTH_DATA_INST=prep_auth_data_encrypt
(wire names elaborate as prep_auth_data_encrypt_<wire>).
"""
