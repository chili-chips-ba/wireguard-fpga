...
"""poly1305_mac instance for the decrypt design: globally visible wires +
the multi-cycle-path compute instance + the FSM MAIN.

Pypeline port of ../pipelinec_build/src/poly1305/poly1305_mac.c with
POLY_MAC_INST=poly1305_mac_decrypt
(wire names elaborate as poly1305_mac_decrypt_<wire>).
"""
...
# (C GLOBAL_VALID_READY_MCP_INST(poly1305_mac_decrypt_compute, u320_t,
...
@MAIN
def poly1305_mac_decrypt_compute():
