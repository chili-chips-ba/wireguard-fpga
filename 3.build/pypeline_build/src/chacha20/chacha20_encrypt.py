...
"""chacha20 instance for the standalone encrypt design: globally visible
wires + the chacha20_loop_body stream pipeline + the FSM MAIN.

Pypeline port of ../pipelinec_build/src/chacha20/chacha20.c with
CHACHA_INST=chacha20_encrypt (wire names elaborate as chacha20_encrypt_<wire>).
"""
...
# (C GLOBAL_VALID_READY_PIPELINE_INST(chacha20_encrypt_pipeline, axis512_t,
