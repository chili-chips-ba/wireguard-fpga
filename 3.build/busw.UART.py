...
ot = ComPort.write(struct.pack('B', int(0x07)))          #CMD 0x07 enter DMEM/CSR write data mode
print("CMD:   ", hex(0x07))
...
ot = ComPort.write(struct.pack('B', int(0x00)))          #DATA0
print("DATA0: ", hex(0x00))

ot = ComPort.write(struct.pack('B', int(0x03)))          #DATA1
...
ot = ComPort.write(struct.pack('B', int(0x0F)))          #WE
print("WE:    ", hex(0x0F))
